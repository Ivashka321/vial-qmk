...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_DEL,  MO(_FN), KC_SPC,  KC_PSCR, KC_RALT, KC_RGUI, KC_RCTL
    ),

    [_FN] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_UP,   KC_F12,  KC_DEL,
